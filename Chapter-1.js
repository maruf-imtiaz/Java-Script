//Chapter 1 - Create a variable type string and try to add a number to it
let a= "Maurf" //string variable
let b= "34"
console.log(a+b);
//Chapter 1 - Use type of operator to find the data type of the string and number variable
console.log(typeof a+b); //output will be string34
console.log(typeof (a+b)); //output will be string
//Chapter 1 - Create a const object in JavaScript. Can you change it to hold a number later?
const c={
    name: "Jubair",
...
//Chapter 1 - Try to add a new key in the const object. Were you able to do it?
...
//Chapter 1 - Write a JavaScript program to create a word meaning dictionary of 5 words.
const dictionary = {
